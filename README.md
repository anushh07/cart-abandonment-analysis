...
# Libraries Used-
 ...
 1. **Pandas** — Used for loading, cleaning, and analyzing the dataset.
 2. **Matplotlib** — Used for visualizing cart abandonment rates.
...
1. X-axis: Product Categories.
2. Y-axis: Abandonment Rate (%).
...
![Category-wise Cart Abandonment Rate](abandonment_rate_by_category.png)
